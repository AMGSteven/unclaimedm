        ...
        <div className="max-w-3xl mx-auto">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1">
              <AccordionTrigger className="text-lg font-medium">What exactly is unclaimed money?</AccordionTrigger>
            ...
            <AccordionItem value="item-3">
              <AccordionTrigger className="text-lg font-medium">Is this service really free?</AccordionTrigger>
              <AccordionContent className="text-gray-600">
            ...
            <AccordionItem value="item-5">
              <AccordionTrigger className="text-lg font-medium">Is this a government website?</AccordionTrigger>
              <AccordionContent className="text-gray-600">
